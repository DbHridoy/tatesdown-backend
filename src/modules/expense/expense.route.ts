...
expenseRoute.post("/mileage", uploadFile({ fieldName: "file", uploadType: "single" }), validate(CreateMileageSchema), expenseController.createNewMileage);

// expenseRoute.get("/pending-mileage", expenseController.getPendingMileage);
// expenseRoute.get("/my-mileage", authMiddleware.authenticate, expenseController.getMyMileage);
